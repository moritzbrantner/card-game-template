...
export const foundationFeatureModules: readonly FoundationFeatureModule[] = [
  {
    ...
    requiredMessageNamespaces: ['AuthPages'],
  ...
  {
    featureKey: 'profiles.public',
    requiredMessageNamespaces: ['ProfilePage'],
    requiredContentCollections: [],
  },
  {
  ...
  },
  {
    ...
    requiredMessageNamespaces: ['BlogPage'],
    requiredContentCollections: [],
  },
  {
    featureKey: 'people.directory',
    requiredMessageNamespaces: ['PeoplePage'],
    requiredContentCollections: [],
  },
  {
    featureKey: 'notifications',
    requiredMessageNamespaces: ['NotificationsPage'],
    requiredContentCollections: [],
  },
  {
  ...
  },
  {
    ...
    requiredMessageNamespaces: ['ReportProblemPage'],
    requiredContentCollections: [],
  },
  {
    featureKey: 'content.blog',
    requiredMessageNamespaces: ['BlogPage'],
    requiredContentCollections: ['blog'],
  },
  {
    featureKey: 'content.changelog',
    requiredMessageNamespaces: [],
    requiredContentCollections: ['changelog'],
  },
  {
    featureKey: 'workspace.dataEntry',
    requiredMessageNamespaces: ['DataEntryPage'],
    requiredContentCollections: [],
  },
  {
    featureKey: 'admin.workspace',
    requiredMessageNamespaces: ['AdminPage'],
    requiredContentCollections: [],
  },
  {
  ...
  },
  {
    ...
    requiredMessageNamespaces: ['FormsPage'],
    requiredContentCollections: [],
  },
  {
    featureKey: 'showcase.phase10',
    requiredMessageNamespaces: ['Phase10Page'],
    requiredContentCollections: [],
  },
  {
  ...
  },
  {
    ...
    requiredMessageNamespaces: ['RemocnPage'],
    requiredContentCollections: [],
  },
  {
  ...
  {
    featureKey: 'showcase.unlighthouse',
    requiredMessageNamespaces: ['UnlighthousePage'],
    requiredContentCollections: [],
  },
] as const;
