...
section "Running containers for card-game-template-web"
docker ps --filter "label=com.docker.compose.project=card-game-template-web" --format 'table {{.Names}}	{{.Status}}	{{.Ports}}' || true
